 ...
 */
void chg_hpt(howmany, alsomax, what)
int howmany;
bool alsomax;
char what;
{
...
bool heave;
{
    ...
    { /* object NOT thrown here (affects armor class) */
        if (edex > 18)
            return (14 - edex);
        switch (edex)
        {
 ...
 *	Heal the hero.
 */
void heal_self(factor, updmaxhp)
int factor;
bool updmaxhp;
{
