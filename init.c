...
char *rainbow[NCOLORS] = { "Red",        "Blue",      "Green",    "Yellow",
...
char *stones[] = { "Agate",     "Alexandrite",   "Amethyst",    "Azurite",
                   "Carnelian", "Chrysoberyl",   "Chrysoprase", "Citrine",
                   "Diamond",   "Emerald",       "Garnet",      "Hematite",
                   "Jacinth",   "Jade",          "Kryptonite",  "Lapus lazuli",
                   "Malachite", "Moonstone",     "Obsidian",    "Olivine",
                   "Onyx",      "Opal",          "Pearl",       "Peridot",
                   "Quartz",    "Rhodochrosite", "Ruby",        "Sapphire",
                   "Sardonyx",  "Serpintine",    "Spinel",      "Tiger eye",
...
char *metal[NMETAL] = { "Aluminium", "Bone",  "Brass", "Bronze",    "Copper",
