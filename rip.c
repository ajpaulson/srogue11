...
static char *rip[] = { "                          ____________________",
		       "                         /                    \\",
		       "                        /  Bob Kindelberger's  \\",
		       "                       /       Graveyard        \\",
		       "                      /                          \\",
...
char monst;
{
	...
	sprintf(prbuf, "%d/%d/%d", lt->tm_mon + 1, lt->tm_mday,
		1900 + lt->tm_year);
...
int amount, aflag;
{
	...
	for (i = 0; i < 10; i++) {
		...
		sscanf(scoreline, " %d %d %d %d %u %d %ld %lx \n",
		       ...
		       &top_ten[i].sc_level, &top_ten[i].sc_uid, &mon,
		       &top_ten[i].sc_explvl, &top_ten[i].sc_exppts,
		       &top_ten[i].sc_date);
